...
const TERMS_BODY = `
  ...
  <p>Please read this section carefully — it limits our liability to you. It works together with the disclaimers in Section 8.</p>
  <p><strong>No indirect or consequential damages.</strong> To the maximum extent permitted by law, Meroa (Jun Kwon) will not be liable for any indirect, incidental, special, consequential, exemplary, or punitive damages, or for any loss of profits, revenue, data, goodwill, or emotional distress, arising out of or relating to your use of, or inability to use, Meroa — even if we were advised of the possibility of such damages.</p>
  <p><strong>AI-generated content.</strong> Meroa's responses are generated by artificial intelligence and may be inaccurate, incomplete, or inappropriate. They are <strong>not professional advice — and specifically not medical, mental-health, therapeutic, legal, or financial advice</strong> — and are not a substitute for professional judgment. You should not rely on Meroa's output for any decision that warrants professional guidance, and we are not liable for any action you take based on it. If you are in crisis or facing an emergency, contact your local emergency services or a qualified professional (see Section 1).</p>
  <p><strong>Your data.</strong> We provide export and deletion controls (see the Privacy Policy) so you can keep your own copy of your information, but we do not warrant that your data will never be lost or corrupted, and to the maximum extent permitted by law we are not liable for any such loss or corruption.</p>
  <p><strong>Reminders and notifications.</strong> Reminders and notifications depend on your device and operating system and may be delayed, duplicated, or not delivered. We are not liable for anything you miss because a reminder or notification did not arrive or arrived late.</p>
  <p><strong>Third-party services.</strong> Meroa relies on third-party providers, including an AI provider, hosting, and payment processing. We are not liable for their acts, outages, failures, or changes.</p>
  <p><strong>Cap on liability.</strong> To the maximum extent permitted by law, our total aggregate liability for all claims relating to Meroa will not exceed the greater of (a) the total amount you paid us for the service in the twelve (12) months before the event giving rise to the claim, or (b) one hundred U.S. dollars ($100).</p>
  <p><strong>What this section does not limit.</strong> Nothing in these Terms excludes or limits any liability, right, or remedy that cannot be excluded or limited under applicable law — including liability for fraud, willful misconduct, or gross negligence; liability for death or personal injury caused by our negligence; and any non-waivable rights or remedies you have under California or other applicable law. A limitation of liability protects us only from claims it is lawfully allowed to limit; it does not waive protections the law makes non-waivable.</p>
  <p>Some jurisdictions do not allow the exclusion or limitation of certain warranties or damages, so some of the above may not apply to you.</p>
